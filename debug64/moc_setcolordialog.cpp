...
#include "../src/dialogs/setcolordialog.h"
...
struct qt_meta_stringdata_SetColorDialog_t {
    QByteArrayData data[6];
    char stringdata0[75];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SetColorDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SetColorDialog_t qt_meta_stringdata_SetColorDialog = {
    {
QT_MOC_LITERAL(0, 0, 14), // "SetColorDialog"
QT_MOC_LITERAL(1, 15, 13), // "selectCurrent"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 12), // "selectCustom"
QT_MOC_LITERAL(4, 43, 16), // "selectLastCustom"
QT_MOC_LITERAL(5, 60, 14) // "selectStandard"
...
const QMetaObject SetColorDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SetColorDialog.data,
      qt_meta_data_SetColorDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SetColorDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SetColorDialog.stringdata0))
