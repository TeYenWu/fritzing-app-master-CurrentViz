...
#include "../src/items/resizableboard.h"
...
QT_MOC_LITERAL(1, 6, 13), // "prepLoadImage"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 13), // "fileNameEntry"
QT_MOC_LITERAL(4, 35, 8) // "filename"

    },
    "Board\0prepLoadImage\0\0fileNameEntry\0"
    "filename"
};
...
const QMetaObject Board::staticMetaObject = {
    { &PaletteItem::staticMetaObject, qt_meta_stringdata_Board.data,
...
struct qt_meta_stringdata_ResizableBoard_t {
    QByteArrayData data[8];
    char stringdata0[94];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ResizableBoard_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ResizableBoard_t qt_meta_stringdata_ResizableBoard = {
    {
QT_MOC_LITERAL(0, 0, 14), // "ResizableBoard"
QT_MOC_LITERAL(1, 15, 10), // "widthEntry"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 11), // "heightEntry"
QT_MOC_LITERAL(4, 39, 15), // "keepAspectRatio"
QT_MOC_LITERAL(5, 55, 10), // "checkState"
QT_MOC_LITERAL(6, 66, 10), // "revertSize"
QT_MOC_LITERAL(7, 77, 16) // "paperSizeChanged"

    },
    "ResizableBoard\0widthEntry\0\0heightEntry\0"
    "keepAspectRatio\0checkState\0revertSize\0"
    "paperSizeChanged"
};
#undef QT_MOC_LITERAL
...
const QMetaObject ResizableBoard::staticMetaObject = {
    { &Board::staticMetaObject, qt_meta_stringdata_ResizableBoard.data,
      qt_meta_data_ResizableBoard,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_ResizableBoard.stringdata0))
