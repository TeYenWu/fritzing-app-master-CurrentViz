...
#include "../src/partsbinpalette/searchlineedit.h"
...
void SearchLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (SearchLineEdit::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SearchLineEdit::clicked)) {
                *result = 0;
                return;
            }
        }
