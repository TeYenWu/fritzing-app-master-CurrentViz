...
#include "../src/utils/familypropertycombobox.h"
...
struct qt_meta_stringdata_FamilyPropertyComboBox_t {
    QByteArrayData data[1];
    char stringdata0[23];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_FamilyPropertyComboBox_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_FamilyPropertyComboBox_t qt_meta_stringdata_FamilyPropertyComboBox = {
    {
QT_MOC_LITERAL(0, 0, 22) // "FamilyPropertyComboBox"
...
const QMetaObject FamilyPropertyComboBox::staticMetaObject = {
    { &FocusOutComboBox::staticMetaObject, qt_meta_stringdata_FamilyPropertyComboBox.data,
      qt_meta_data_FamilyPropertyComboBox,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FamilyPropertyComboBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FamilyPropertyComboBox.stringdata0))
