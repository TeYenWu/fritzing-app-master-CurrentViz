...
struct qt_meta_stringdata_Perfboard_t {
    QByteArrayData data[4];
    char stringdata0[43];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Perfboard_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Perfboard_t qt_meta_stringdata_Perfboard = {
    {
QT_MOC_LITERAL(0, 0, 9), // "Perfboard"
QT_MOC_LITERAL(1, 10, 15), // "changeBoardSize"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 15) // "enableSetButton"

    },
    "Perfboard\0changeBoardSize\0\0enableSetButton"
};
...
const QMetaObject Perfboard::staticMetaObject = {
    { &Capacitor::staticMetaObject, qt_meta_stringdata_Perfboard.data,
      qt_meta_data_Perfboard,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Perfboard::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Perfboard.stringdata0))
