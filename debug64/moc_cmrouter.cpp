...
#include "../src/autoroute/cmrouter/cmrouter.h"
...
struct qt_meta_stringdata_CMRouter_t {
    QByteArrayData data[1];
    char stringdata0[9];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CMRouter_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CMRouter_t qt_meta_stringdata_CMRouter = {
    {
QT_MOC_LITERAL(0, 0, 8) // "CMRouter"
...
const QMetaObject CMRouter::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CMRouter.data,
      qt_meta_data_CMRouter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CMRouter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CMRouter.stringdata0))
