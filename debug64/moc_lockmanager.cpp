...
#include "../src/utils/lockmanager.h"
...
struct qt_meta_stringdata_LockManager_t {
    QByteArrayData data[3];
    char stringdata0[24];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_LockManager_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_LockManager_t qt_meta_stringdata_LockManager = {
    {
QT_MOC_LITERAL(0, 0, 11), // "LockManager"
QT_MOC_LITERAL(1, 12, 10), // "touchFiles"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "LockManager\0touchFiles\0"
};
...
const QMetaObject LockManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_LockManager.data,
      qt_meta_data_LockManager,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *LockManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LockManager.stringdata0))
