...
struct qt_meta_stringdata_PinHeader_t {
    QByteArrayData data[4];
    char stringdata0[26];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PinHeader_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PinHeader_t qt_meta_stringdata_PinHeader = {
    {
QT_MOC_LITERAL(0, 0, 9), // "PinHeader"
QT_MOC_LITERAL(1, 10, 9), // "swapEntry"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 4) // "text"

    },
    "PinHeader\0swapEntry\0\0text"
};
...
const QMetaObject PinHeader::staticMetaObject = {
    { &PaletteItem::staticMetaObject, qt_meta_stringdata_PinHeader.data,
      qt_meta_data_PinHeader,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PinHeader::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PinHeader.stringdata0))
