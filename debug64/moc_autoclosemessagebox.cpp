...
#include "../src/utils/autoclosemessagebox.h"
...
struct qt_meta_stringdata_AutoCloseMessageBox_t {
    QByteArrayData data[5];
    char stringdata0[43];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_AutoCloseMessageBox_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AutoCloseMessageBox_t qt_meta_stringdata_AutoCloseMessageBox = {
    {
QT_MOC_LITERAL(0, 0, 19), // "AutoCloseMessageBox"
QT_MOC_LITERAL(1, 20, 7), // "moveOut"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 8), // "moveBack"
QT_MOC_LITERAL(4, 38, 4) // "wait"

    },
    "AutoCloseMessageBox\0moveOut\0\0moveBack\0"
    "wait"
};
...
const QMetaObject AutoCloseMessageBox::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_AutoCloseMessageBox.data,
      qt_meta_data_AutoCloseMessageBox,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AutoCloseMessageBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AutoCloseMessageBox.stringdata0))
