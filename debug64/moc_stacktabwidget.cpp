...
#include "../src/partsbinpalette/binmanager/stacktabwidget.h"
...
struct qt_meta_stringdata_StackTabWidget_t {
    QByteArrayData data[8];
    char stringdata0[116];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_StackTabWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_StackTabWidget_t qt_meta_stringdata_StackTabWidget = {
    {
QT_MOC_LITERAL(0, 0, 14), // "StackTabWidget"
QT_MOC_LITERAL(1, 15, 14), // "currentChanged"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 15), // "StackTabWidget*"
QT_MOC_LITERAL(4, 47, 5), // "index"
QT_MOC_LITERAL(5, 53, 17), // "tabCloseRequested"
QT_MOC_LITERAL(6, 71, 20), // "informCurrentChanged"
QT_MOC_LITERAL(7, 92, 23) // "informTabCloseRequested"

    },
    "StackTabWidget\0currentChanged\0\0"
    "StackTabWidget*\0index\0tabCloseRequested\0"
    "informCurrentChanged\0informTabCloseRequested"
};
...
void StackTabWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 0:
            ...
            default: *reinterpret_cast<int*>(_a[0]) = -1; break;
            case 0:
                *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< StackTabWidget* >(); break;
            }
            break;
        case 1:
            switch (*reinterpret_cast<int*>(_a[1])) {
        ...
        {
            typedef void (StackTabWidget::*_t)(StackTabWidget * , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StackTabWidget::currentChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (StackTabWidget::*_t)(StackTabWidget * , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StackTabWidget::tabCloseRequested)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject StackTabWidget::staticMetaObject = {
    { &QTabWidget::staticMetaObject, qt_meta_stringdata_StackTabWidget.data,
      qt_meta_data_StackTabWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *StackTabWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_StackTabWidget.stringdata0))
