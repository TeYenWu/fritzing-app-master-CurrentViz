...
public:
    ...
    {
        ConsoleSettings->setWindowTitle(QApplication::translate("ConsoleSettings", "Settings", Q_NULLPTR));
        parametersBox->setTitle(QApplication::translate("ConsoleSettings", "Select Parameters", Q_NULLPTR));
        baudRateLabel->setText(QApplication::translate("ConsoleSettings", "BaudRate:", Q_NULLPTR));
        dataBitsLabel->setText(QApplication::translate("ConsoleSettings", "Data bits:", Q_NULLPTR));
        parityLabel->setText(QApplication::translate("ConsoleSettings", "Parity:", Q_NULLPTR));
        stopBitsLabel->setText(QApplication::translate("ConsoleSettings", "Stop bits:", Q_NULLPTR));
        flowControlLabel->setText(QApplication::translate("ConsoleSettings", "Flow control:", Q_NULLPTR));
        selectBox->setTitle(QApplication::translate("ConsoleSettings", "Select Serial Port", Q_NULLPTR));
        descriptionLabel->setText(QApplication::translate("ConsoleSettings", "Description:", Q_NULLPTR));
        manufacturerLabel->setText(QApplication::translate("ConsoleSettings", "Manufacturer:", Q_NULLPTR));
        serialNumberLabel->setText(QApplication::translate("ConsoleSettings", "Serial number:", Q_NULLPTR));
        locationLabel->setText(QApplication::translate("ConsoleSettings", "Location:", Q_NULLPTR));
        vidLabel->setText(QApplication::translate("ConsoleSettings", "Vendor ID:", Q_NULLPTR));
        pidLabel->setText(QApplication::translate("ConsoleSettings", "Product ID:", Q_NULLPTR));
        applyButton->setText(QApplication::translate("ConsoleSettings", "Apply", Q_NULLPTR));
        additionalOptionsGroupBox->setTitle(QApplication::translate("ConsoleSettings", "Additional options", Q_NULLPTR));
        localEchoCheckBox->setText(QApplication::translate("ConsoleSettings", "Local echo", Q_NULLPTR));
    } // retranslateUi
