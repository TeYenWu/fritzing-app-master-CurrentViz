...
#include "../src/dock/layerpalette.h"
...
struct qt_meta_stringdata_ViewLayerCheckBox_t {
    QByteArrayData data[1];
    char stringdata0[18];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ViewLayerCheckBox_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ViewLayerCheckBox_t qt_meta_stringdata_ViewLayerCheckBox = {
    {
QT_MOC_LITERAL(0, 0, 17) // "ViewLayerCheckBox"
...
const QMetaObject ViewLayerCheckBox::staticMetaObject = {
    { &QCheckBox::staticMetaObject, qt_meta_stringdata_ViewLayerCheckBox.data,
      qt_meta_data_ViewLayerCheckBox,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ViewLayerCheckBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ViewLayerCheckBox.stringdata0))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_LayerPalette_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_LayerPalette_t qt_meta_stringdata_LayerPalette = {
    {
QT_MOC_LITERAL(0, 0, 12), // "LayerPalette"
QT_MOC_LITERAL(1, 13, 18), // "setLayerVisibility"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 3), // "vis"
QT_MOC_LITERAL(4, 37, 19) // "setAllLayersVisible"

    },
    "LayerPalette\0setLayerVisibility\0\0vis\0"
    "setAllLayersVisible"
};
#undef QT_MOC_LITERAL
...
const QMetaObject LayerPalette::staticMetaObject = {
    { &QScrollArea::staticMetaObject, qt_meta_stringdata_LayerPalette.data,
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_LayerPalette.stringdata0))
