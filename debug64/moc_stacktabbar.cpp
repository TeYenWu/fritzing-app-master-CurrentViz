...
#include "../src/partsbinpalette/binmanager/stacktabbar.h"
...
struct qt_meta_stringdata_StackTabBar_t {
    QByteArrayData data[5];
    char stringdata0[44];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_StackTabBar_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_StackTabBar_t qt_meta_stringdata_StackTabBar = {
    {
QT_MOC_LITERAL(0, 0, 11), // "StackTabBar"
QT_MOC_LITERAL(1, 12, 8), // "setIndex"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 15), // "showContextMenu"
QT_MOC_LITERAL(4, 38, 5) // "point"

    },
    "StackTabBar\0setIndex\0\0showContextMenu\0"
    "point"
};
...
const QMetaObject StackTabBar::staticMetaObject = {
    { &QTabBar::staticMetaObject, qt_meta_stringdata_StackTabBar.data,
      qt_meta_data_StackTabBar,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *StackTabBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_StackTabBar.stringdata0))
