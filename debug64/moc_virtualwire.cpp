...
#include "../src/items/virtualwire.h"
...
struct qt_meta_stringdata_VirtualWire_t {
    QByteArrayData data[1];
    char stringdata0[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_VirtualWire_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_VirtualWire_t qt_meta_stringdata_VirtualWire = {
    {
QT_MOC_LITERAL(0, 0, 11) // "VirtualWire"
...
const QMetaObject VirtualWire::staticMetaObject = {
    { &ClipableWire::staticMetaObject, qt_meta_stringdata_VirtualWire.data,
      qt_meta_data_VirtualWire,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *VirtualWire::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VirtualWire.stringdata0))
