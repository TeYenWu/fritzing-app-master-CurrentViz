...
#include "../src/items/jumperitem.h"
...
struct qt_meta_stringdata_JumperItem_t {
    QByteArrayData data[6];
    char stringdata0[43];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_JumperItem_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_JumperItem_t qt_meta_stringdata_JumperItem = {
    {
QT_MOC_LITERAL(0, 0, 10), // "JumperItem"
QT_MOC_LITERAL(1, 11, 7), // "alignMe"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 11), // "JumperItem*"
QT_MOC_LITERAL(4, 32, 8), // "QPointF&"
QT_MOC_LITERAL(5, 41, 1) // "p"

    },
    "JumperItem\0alignMe\0\0JumperItem*\0"
    "QPointF&\0p"
};
...
void JumperItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 0:
            ...
            default: *reinterpret_cast<int*>(_a[0]) = -1; break;
            case 0:
                *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< JumperItem* >(); break;
            }
            break;
        }
        ...
        {
            typedef void (JumperItem::*_t)(JumperItem * , QPointF & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&JumperItem::alignMe)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject JumperItem::staticMetaObject = {
    { &PaletteItem::staticMetaObject, qt_meta_stringdata_JumperItem.data,
      qt_meta_data_JumperItem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *JumperItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_JumperItem.stringdata0))
