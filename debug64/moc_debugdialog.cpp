...
QT_MOC_LITERAL(1, 12, 14), // "debugBroadcast"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 7), // "message"
QT_MOC_LITERAL(4, 36, 10), // "DebugLevel"
QT_MOC_LITERAL(5, 47, 8) // "ancestor"

    },
    "DebugDialog\0debugBroadcast\0\0message\0"
    "DebugLevel\0ancestor"
};
...
static const uint qt_meta_data_DebugDialog[] = {
 ...
 // signals: parameters
    QMetaType::Void, QMetaType::QString, 0x80000000 | 4, QMetaType::QObjectStar,    3,    2,    5,
...
void DebugDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (DebugDialog::*_t)(const QString & , DebugLevel , QObject * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DebugDialog::debugBroadcast)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject DebugDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DebugDialog.data,
      qt_meta_data_DebugDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
