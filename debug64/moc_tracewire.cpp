...
struct qt_meta_stringdata_TraceWire_t {
    QByteArrayData data[4];
    char stringdata0[27];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_TraceWire_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TraceWire_t qt_meta_stringdata_TraceWire = {
    {
QT_MOC_LITERAL(0, 0, 9), // "TraceWire"
QT_MOC_LITERAL(1, 10, 10), // "widthEntry"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 4) // "text"

    },
    "TraceWire\0widthEntry\0\0text"
};
...
const QMetaObject TraceWire::staticMetaObject = {
    { &ClipableWire::staticMetaObject, qt_meta_stringdata_TraceWire.data,
      qt_meta_data_TraceWire,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TraceWire::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TraceWire.stringdata0))
