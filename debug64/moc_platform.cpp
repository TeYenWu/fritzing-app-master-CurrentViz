...
QT_MOC_LITERAL(1, 9, 22), // "commandLocationChanged"
QT_MOC_LITERAL(2, 32, 0) // ""

    },
    "Platform\0commandLocationChanged\0"
};
...
void Platform::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->commandLocationChanged(); break;
        default: ;
        }
        ...
        {
            typedef void (Platform::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Platform::commandLocationChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Platform::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Platform.data,
      qt_meta_data_Platform,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void Platform::commandLocationChanged()
{
