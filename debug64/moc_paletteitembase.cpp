...
#include "../src/items/paletteitembase.h"
...
struct qt_meta_stringdata_PaletteItemBase_t {
    QByteArrayData data[3];
    char stringdata0[35];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PaletteItemBase_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PaletteItemBase_t qt_meta_stringdata_PaletteItemBase = {
    {
QT_MOC_LITERAL(0, 0, 15), // "PaletteItemBase"
QT_MOC_LITERAL(1, 16, 17), // "partPropertyEntry"
...
const QMetaObject PaletteItemBase::staticMetaObject = {
    { &ItemBase::staticMetaObject, qt_meta_stringdata_PaletteItemBase.data,
      qt_meta_data_PaletteItemBase,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PaletteItemBase::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PaletteItemBase.stringdata0))
