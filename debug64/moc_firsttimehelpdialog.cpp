...
#include "../src/help/firsttimehelpdialog.h"
...
struct qt_meta_stringdata_FirstTimeHelpDialog_t {
    QByteArrayData data[1];
    char stringdata0[20];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_FirstTimeHelpDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_FirstTimeHelpDialog_t qt_meta_stringdata_FirstTimeHelpDialog = {
    {
QT_MOC_LITERAL(0, 0, 19) // "FirstTimeHelpDialog"
...
const QMetaObject FirstTimeHelpDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_FirstTimeHelpDialog.data,
      qt_meta_data_FirstTimeHelpDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FirstTimeHelpDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FirstTimeHelpDialog.stringdata0))
