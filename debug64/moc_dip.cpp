...
struct qt_meta_stringdata_Dip_t {
    QByteArrayData data[4];
    char stringdata0[20];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Dip_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Dip_t qt_meta_stringdata_Dip = {
    {
QT_MOC_LITERAL(0, 0, 3), // "Dip"
QT_MOC_LITERAL(1, 4, 9), // "swapEntry"
QT_MOC_LITERAL(2, 14, 0), // ""
QT_MOC_LITERAL(3, 15, 4) // "text"

    },
    "Dip\0swapEntry\0\0text"
};
...
const QMetaObject Dip::staticMetaObject = {
    { &MysteryPart::staticMetaObject, qt_meta_stringdata_Dip.data,
      qt_meta_data_Dip,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Dip::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Dip.stringdata0))
