...
struct qt_meta_stringdata_FMessageBox_t {
    QByteArrayData data[1];
    char stringdata0[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_FMessageBox_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_FMessageBox_t qt_meta_stringdata_FMessageBox = {
    {
QT_MOC_LITERAL(0, 0, 11) // "FMessageBox"
...
const QMetaObject FMessageBox::staticMetaObject = {
    { &QMessageBox::staticMetaObject, qt_meta_stringdata_FMessageBox.data,
      qt_meta_data_FMessageBox,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FMessageBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FMessageBox.stringdata0))
